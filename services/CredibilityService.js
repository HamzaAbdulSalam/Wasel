...
// Vote weights for credibility scoring
const VOTE_WEIGHTS = {
  helpful: 1,
  not_helpful: -0.5,
  spam: -2,
...
class CredibilityService {
  ...
  // Calculate credibility score for a report
  ...
  // Update report credibility score
  ...
  // Get most helpful reports (by credibility score)
  ...
  // Get most controversial reports (high positive AND negative votes)
  static async getMostControversialReports(filters = {}) {
    ...
    // Calculate controversy score (sum of absolute vote weights)
  ...
  // Get trending reports (high recent activity)
  static async getTrendingReports(filters = {}) {
    ...
    // Calculate trend score based on votes and recency
